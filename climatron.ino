...
void networkWiFiManagerBuildParameters()
{
  ...
  pMqttPassword = new WiFiManagerParameter(
    ...
    26  // Allow for passwords at least up to and including 24 characters
  );
...
void networkWiFiManagerRefreshParameterValues()
{
  ...
  if (pMqttPassword) {
    pMqttPassword->setValue(mqttBrokerConfig.password.c_str(), 26);  // Allow for passwords up to 24 characters
  }
#endif
